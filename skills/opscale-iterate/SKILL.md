...
Compose the commit in Conventional Commits format. The full rules, type table, and examples are in `references/commit-message.md` — read it before writing the message.
